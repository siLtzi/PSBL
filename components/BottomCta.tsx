    ...
    <section className="relative bg-[var(--yellow)] text-[var(--black)]">
      ...
      <div className="py-16 md:py-20 px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div
              className={`${barlow.className} text-[0.65rem] font-semibold tracking-[3px] uppercase text-[var(--black)]/60 mb-4 flex items-center gap-3`}
            >
              <span className="text-[var(--black)]/30">{"//"}</span>
              Ota yhteyttä
            </div>
            <h2
              className={`${barlowCondensed.className} font-black text-[clamp(1.8rem,5vw,4.5rem)] uppercase tracking-[2px] leading-[0.95]`}
            >
              Tarvitsetko
              <br />
              lattiaurakoitsijan?
          ...
          <div className="flex flex-col gap-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className={`${barlow.className} text-[0.6rem] tracking-[2px] uppercase font-semibold opacity-60`}>PSBL</div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className={`${barlow.className} text-[0.6rem] tracking-[2px] uppercase font-semibold opacity-60`}>Sähköposti</div>
            ...
            <Link
              href="/yhteystiedot"
              className={`${barlowCondensed.className} button-cta button-cta-arrow button-cta-fill-dark group inline-flex items-center justify-center uppercase font-extrabold text-lg tracking-[2px] bg-[var(--black)] text-[var(--yellow)] px-10 py-4 w-fit`}
            >
              <span className="button-cta-label">Pyydä tarjous</span>
              <span aria-hidden="true" className="button-cta-icon-out">→</span>
              <span aria-hidden="true" className="button-cta-icon-in">→</span>
            </Link>
          </div>
        </div>
      </div>
